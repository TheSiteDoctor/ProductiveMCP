      ...
      inputSchema: {
        ...
        properties: {
          ...
          workflow_status: {
            type: "string",
            description:
              "Optional workflow status name (e.g. 'To Do', 'In Progress'). Valid names come from productive.config.json (generated by `npm run setup`); an unrecognised name returns an error listing the available statuses.",
          },
          response_format: {
            type: "string",
            enum: ["markdown", "json"],
